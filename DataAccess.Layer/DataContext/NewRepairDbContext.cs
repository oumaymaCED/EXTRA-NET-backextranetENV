...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=LAP-TUN-6V8PH33\\SQLEXPRESS;Database=NewRepair-db-qa-data;Trusted_Connection=True;TrustServerCertificate=True;Encrypt=False;Connect timeout=1200");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PurchaseInvoiceLine>(entity =>
        {
            ...
            entity.Property(e => e.IsTaken).HasMaxLength(50);


            entity.HasOne(d => d.PurchaseInvoiceNumberNavigation)
